%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Position, Velocity and Acceleration analysis of a Cylindrical Joint with ground. 
% Input: input all the attributes in the 'input.txt' file
% Output: Position, Velocity and Acceleration for the Cylindrical Joints.
% A Cylindrical Joint has two DP1 and two DP2 Constraints
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('The two bodies are connected by a Cylindrical Joint.')
...
for n = 1:length(ts)
    ...
    gcon_inp.ddft = 0;
    gcon_inp.r1 = r1;
    gcon_inp.r1dot = r1dot;
    gcon_inp.r2 = r2;
    gcon_inp.r2dot = r2dot;
    gcon_inp.s1_p = s1_p;
    gcon_inp.s2_q = s2_q;
    gcon_inp.i = i;
    gcon_inp.j = j;
    ...
    % calling 2 DP1 GCon and 2DP2 GCons to form Cylindrical  Joint
    ...
    w = w+1;
    [phi(w,1),nu(w,1),gamma(w,1),dphi_dr(w,:),dphi_dp(w,:)] = cons_DP2(gcon_inp);
    w = w+1;
    [phi(w,1),nu(w,1),gamma(w,1),dphi_dr(w,:),dphi_dp(w,:)] = cons_DP2(gcon_inp);
...
disp('Results have been saved as output.')