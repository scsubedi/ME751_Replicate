%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Position, Velocity and Acceleration analysis of a Perpendicular 2 GCon
% with one body grounded.
% Input: input all the attributes in the 'input.txt' file
% Output: Position, velocity and acceleration values for the Gcon
% A perpendicular 2 Gcon is made out of two DP2 constraints.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('The two bodies have a perpendicular 2 constraint.')
...
for n = 1:length(ts)
    ...
    % calling 2 DP2 GCon to create a Perpendicular 2 GCon
