function [ DP1, VelocityDP1, AccelerationDP1, PartialPhi_rDP1, PartialPhi_pDP1] = cons_dp1(inputs,flags,groundStatus)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     dijDot = inputs{32};
    ...
    saveFile(ResultsUnGroundedDP1,str1,str2,str4);
    ...
    PartialPhi_rDP1 = [PartialPhi_ri];
    PartialPhi_pDP1 = [PartialPhi_pi];
    
    ResultsGroundedDP1 = {DP1 VelocityDP1 AccelerationDP1...
        PartialPhi_ri PartialPhi_pi};
    
    saveFile(ResultsGroundedDP1,str1,str3,str4);
end
...
if (bodyJGround== true)
    fprintf('The body J is grounded. \n');
      fprintf('The bodies I and J have a Dot Product 1(DP1) constraint. \n');
